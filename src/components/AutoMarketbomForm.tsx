                    ...
                    <div key={item.id} className="border rounded bg-background">
                      ...
                      <div className="px-3 py-2 space-y-2">
                        ...
                        <div className="bg-muted/50 rounded p-2 space-y-1 text-xs">
                          ...
                          <div className="flex justify-between"><span className="text-muted-foreground">기본 발주량 후보</span><span>{d.defaultOrderCandidate || '-'}</span></div>
                          <div className="flex justify-between"><span className="text-muted-foreground">최소 기준 후보</span><span>{d.minThresholdCandidate ? round2(d.minThresholdCandidate) : '-'}</span></div>
                          <div className="flex justify-between"><span className="text-muted-foreground">추천 발주량</span><b className="text-primary">{d.recommendedOrder || '-'}</b></div>
                        </div>
                        <label className="flex items-center justify-between gap-2 text-xs">
                          <span className="font-medium">최종 발주량</span>
              ...
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-muted/50">
                    ...
                    <th className="border px-1 py-1 w-10">기본후보</th>
                    <th className="border px-1 py-1 w-10">최소기준</th>
                    <th className="border px-1 py-1 w-12">추천</th>
