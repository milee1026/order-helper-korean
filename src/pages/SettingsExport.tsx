...
import { saveSettings, useRecords, useSettings, saveRecords } from '@/utils/storage';
...
export function SettingsExport() {
  ...
  const handleClearAll = () => {
    ...
    toast({ title: '전체 삭제 완료', description: '로컬 백업은 유지됩니다.' });
  };
  ...
  return (
    <div className="space-y-3">
      ...
      <CollapsibleSection title="데이터 관리" defaultOpen={false}>
        <div className="space-y-2">
          <p className="text-xs text-muted-foreground">현재 저장된 기록: {records.length}건</p>
